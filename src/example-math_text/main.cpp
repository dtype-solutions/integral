...
int main(int main_argc, char* main_argv[])
{
	...
	std::cout << "Source File: example-math_text/main.cpp\n";
	std::cout << "------------------------------------------------------\n";
	std::cout << "\n";
	std::cout << "A demonstration of mixing text, rich-text formatting and embedded math.\n";
	std::cout << "\n";
	...
	CDTApplet applet(engine, display, "D-Type Example", display.Dist(1024), display.Dist(800), DV_WINDOW_HINT_RESIZE | DV_WINDOW_HINT_CENTER | DV_WINDOW_HINT_FULLRESOLUTION /* | DV_WINDOW_HINT_RGB */, 0.2 /* initial zoom */);
